...
county1 <- get_decennial(year=2020,  sumfile="dp", 
                         geography = "county", state="CA", county="Alameda",
...
county1_pyramid <- ggplot(county1a, aes(x = value, y = agerange, fill = Sex)) + 
...
ggsave("census2020_agesex_pyramid_AlamedaCounty.png", plot=last_plot(),
